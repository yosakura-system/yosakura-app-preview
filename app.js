...
(() => {
  ...
  const STORE_ALIASES = {
    ...
    /* ⚠️ 会議の記録に「日本料理世桜 長堀橋店」という呼び方が出る（2026-08-12／2026-08-19）。
       高原社長のご回答（2026-08-20）＝日本料理世桜は日本鰻世桜 長堀橋と同じ場所にある。
       ＝本店を指しているとみて寄せる。**14店舗目として増えないようにするための予防。**
       ★これは推測を含む。表記が正式なものとして本部から出てきたら、そのときに直す。 */
  ...
  /* </embed-icons> */
  const APP_BUILD = 'yosakura-hq-v115';
  let LATEST_BUILD = '';

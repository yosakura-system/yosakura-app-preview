...
(() => {
  ...
  /* </embed-icons> */
  const APP_BUILD = 'yosakura-hq-v126';
  let LATEST_BUILD = '';
  ...
  render();
  写真選択中の再読み込みを報告_(); // ★前回、写真の選択中に再読み込みが起きていたら画面に出す（iPhoneホーム画面版の切り分け）
  syncReports(true);

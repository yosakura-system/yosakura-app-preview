...
(() => {
  ...
  const MANUAL_CATALOG = [
    ...
    { ic:'grad',  gyotai:'all', roles:['staff','manager'],   mat:['lk_d1','lk_d2','lk_d3','lk_d4','lk_d5','lk_d6','lk_d7','lk_d8','lk_d9','lk_s1','lk_s2','lk_s4'], t:{ja:'7DAYS（新人教育）',en:'7DAYS (onboarding)',vi:'7DAYS (đào tạo)'}, s:{ja:'7DAYS研修（1〜7日目）／ハウスルール／身だしなみ',en:'7DAYS (day1-7) / house rules / grooming',vi:'7DAYS / nội quy / tác phong'} },
